...
const totalAmountToPay = document.querySelector(".total-bill-amount-to-pay");
const totalTipPercentageValue = document.querySelector(".discount-value");
const discountPercentageValue = document.querySelector(".tip-value");
const totalNoOfCustomerValue = document.querySelector(".no-of-customers-value");
...
function calculateBill() {
  ...
  totalNoOfCustomerValue.textContent = noOfCustomers.value;
